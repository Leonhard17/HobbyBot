...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define ServoAngleUpdateTime 20
/* USER CODE END PD */
...
/* USER CODE BEGIN PV */
// Servo
PCA9685_HandleTypeDef servoController;
uint16_t currentAngle[6] = {135, 135, 135, 135, 135, 135};
uint16_t angle[6] = {135, 135, 135, 135, 135, 135};

// Serial COM
uint32_t message_lenght = 0;
